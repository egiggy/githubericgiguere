				...
				<div class="sidebar-right">
					<div class="page-w600">	
						<div class="last-port-title">
								<?php if(is_category()):echo "<h3 class='cufon'>".single_cat_title( '', false )."</h3>";?>	
								<?php elseif(is_tag()): echo "<h3 class='cufon'>".single_tag_title( '', false )."</h3>";?>	
								<?php elseif(is_archive()): echo "<h3 class='cufon'>".get_the_date('F Y')."</h3>";?> 
								<?php endif?>	
						</div>
				 	<?php if(have_posts()) : ?>
