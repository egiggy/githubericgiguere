...
function sdt_post_meta_boxes() {
	...
	$meta_boxes = array(
			...
			'desc-style' => array( 'name' => 'desc-style', 'title' => 'Caption Style', 'type' => 'select', 'options' => array( 0 => 'Title Only',1 => 'Caption Only', 2 => 'Title and Caption' ) ),'social' => array( 'name' => 'social-share', 'title' => 			'Social Network Sharing', 'type' => 'select', 'options' => array( 0 => 'Yes',1 => 'No' ) ),
			'video-title' => array( 'name' => 'video-title' , 'title' => 'Video as Thumbnail (if you use this option "Featured image box will be ignored")' , 'type' => 'header' ),
			'video-type' => array( 'name' => 'video-type', 'title' => 'Video Type', 'type' => 'select', 'options' => array( 0 => 'No video',1 => 'Youtube', 2=> 'Vimeo') ),
			'video-id' => array( 'name' => 'video-id', 'title' => 'Id of your video (ex. Youtube > n-ae9_DgKso or Vimeo > 19489022 )', 'type' => 'text' ),
			'thumbnail-title' => array( 'name' => 'thumbnail-title' , 'title' => 'Thumbnail in post' , 'type' => 'header' ),
			'video-type-in' => array( 'name' => 'video-type-in', 'title' => 'Video Type', 'type' => 'select', 'options' => array( 0 => 'No video',1 => 'Youtube', 2=> 'Vimeo') ),
			'video-id-in' => array( 'name' => 'video-id-in', 'title' => 'Id of your video (ex. Youtube > n-ae9_DgKso or Vimeo > 19489022 )', 'type' => 'text' ),
			'thumbnail' => array( 'name' => 'thumbnail', 'title' => 'Select Image', 'type' => 'upload'),
			'bg-setting-title' => array( 'name' => 'bg-setting-title' , 'title' => 'Background Setting' , 'type' => 'header' ),
			'bg-option-single' => array( 'name' => 'bg-option-single' , 'title' => 'Background Options' , 'type' => 'select' , 'options' => array( 0 => 'No background',1 => 'The same as main slider', 2 => 'Specific image')  ),
			'bg-spec-single' => array( 'name' => 'bg-spec-single', 'title' => 'Select specific background', 'type' => 'upload'),
...
function sdt_page_meta_boxes() {
	...
	$meta_boxes = array(
		...
		'show-excerpt' => array( 'name' => 'show-excerpt', 'type' => 'select' , 'title' => 'Show excerpt while hover', 'options' => array( 0 => 'Yes',1 => 'No' ) ),
		'show-title' => array( 'name' => 'show-title', 'type' => 'select' , 'title' => 'Show title below thumbnail', 'options' => array( 0 => 'Yes',1 => 'No' ) ),
		...
		'bg-setting-title' => array( 'name' => 'bg-setting-title' , 'title' => 'Background Setting' , 'type' => 'header' ),
		'bg-option' => array( 'name' => 'bg-option' , 'title' => 'Background Options' , 'type' => 'select' , 'options' => array( 0 => 'No background',1 => 'The same as main slider', 2 => 'Specific image')  ),
		'bg-spec' => array( 'name' => 'bg-spec', 'title' => 'Select specific background', 'type' => 'upload'),
	);
	...
	<tr>
		...
		<td style="text-align: left;">
			...
			<div class="image-thumb">
				<?php if ($value_exists) { echo  "<div style='width: 65px; height: 50px;border: 1px #ddd solid; margin-bottom: 10px;'><img src=\"".home_url( '/' )."/".htmlentities( $value, ENT_QUOTES )."\" height='50' width='65'></div>" ; } else { echo ""; } ?>
			</div>
