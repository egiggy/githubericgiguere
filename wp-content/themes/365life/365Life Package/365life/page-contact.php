...
if(isset($_POST['submitted-page'])) {
	...
	if(trim($_POST['checking-page']) !== '') {
		...
		if(!isset($hasError_page)) {
			...
			$emailTo_page = get_option ('365l_contact_email');
									...
									<?php while(have_posts()) : the_post();?>	
											...
											<form action="<?php the_permalink(); ?>" id="contactForm-page" method="post">
												...
												<ol class="forms">
													...
													<li class="buttons"><input type="hidden" name="submitted-page" id="submitted-page" value="true" /><button type="submit" class="button mb0">SEND</button></li>
												</ol>
											</form>
											</div>
