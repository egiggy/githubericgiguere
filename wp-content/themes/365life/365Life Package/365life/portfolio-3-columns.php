						...
						<?php while(have_posts()) : the_post();?>		
							<?php include('include/portfolio/portfolio-check-case.php');?>
								...
								?>
										...
										<div class="<?php foreach( $getcat as $category ) { echo str_replace (" ", "",$category->name). '-forfilter '; } ?>All port-3-wrapper portfolio-item">
											<div class="h190 frame relative">
														
													<?php if($video_type !=  "No video" && $video_id != ""):?>
														<?php echo videoThumbnail( '300', '190',$video_type, $video_id );?>	
													<?php else: ?>	
														<div class="hover-port relative h190">
																<div class="<?php if($th_lightbox || $th_post): echo "portfolio-hover"; endif?>">
																		
																		<?php 
																		//check if show title
																		if($show_title == "Yes"):?>
																			<div class="last-port-item-link top60">	
																				<h4 class="cufon">
																		...
																		if($show_excerpt == "Yes"):?>
																			<div class="last-port-excerpt top100 w260">			
																				<?php echo substr(get_the_excerpt(),0,70)."...";?> 																					</div>
																		<?php endif ?>
															...
															<div>
																...
																<?php if($image_id  == null):?>
																	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/img/default.jpg&amp;h=190&amp;w=300&amp;zc=1" alt="<?php the_title(); ?>"/>
																<?php else: ?>
																	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $image_url[0];?>&amp;h=190&amp;w=300&amp;zc=1" alt="<?php the_title(); ?>"/>
																<?php endif ?>
															</div>
														<?php //end image frame?>
														</div>
