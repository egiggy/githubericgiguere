...
<form method="post" id="admin-panel" action="" class="wrapper">
		<div class="theme-title">	
			...
			<div class="title-submit">	
				<span class="load-save"></span><input name="save" type="submit" value="<?php _e('Save changes','365life'); ?>" class="button"/> 
			</div>
		</div>
<!--
	<div class="submit top-submit">
		<input name="save" type="submit" value="<?php _e('Save changes','365life'); ?>"  class="button"/>
...
<div class="form-table">
	...
	?>
		<div valign="top">
			<div class="left" scope="row"><label for="<?php echo $value['id']; ?>"><?php echo __($value['name'],'365life'); ?></label></div>
			<div class="right">
				<div class="input-box"> 
				...
				<?php 
					if(!empty($value["desc"])):
				?>
					<div class="desc-icon"><div class="hide"><?php echo __($value['desc'],'365life');?></div></div>
				<?php
				endif
				?>
			...
			<div class="right">
				<div class="input-box">
					...
					if( get_option($value['id']) != "") {
							echo __(stripslashes(get_option($value['id'])),'365life');
						} elseif(isset($value['std'])){
							echo __($value['std'],'365life');
					}?>
...
<?php
		...
		case 'nothing':
		?>
			<?php echo __("<div>".$value['desc']."</div>",'365life'); ?>
<?php 	break;
...
<?php
		...
		?>
		<div valign="top">
			<div class="left" scope="row"><?php echo __($value['name'],'365life'); ?></div>
			<div class="right">
		...
		?>
			...
			<?php // Delete ?>
				...
				<div valign="top">
					<div class="left" scope="row"><label><?php echo __($value['name'],'365life'); ?></label></div>
					<div class="right">
						<div class="input-box"> 
