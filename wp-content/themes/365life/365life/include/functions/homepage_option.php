...
$homepage = array(
	array(
		...
		"icon" => "home",
		"type" => "tab_list",
		"options" => array(array("Homepage Sidebar Setting","sidebar_homepage"),array("Front Service","homepage_front_service"),array("Last From Portfolio","homepage_last_port"),array("Last From Blog","homepage_last_blog"),array("Blog Featured","homepage_blog_featured"))
	),
		
/**
** Homepage Sidebar Setting
**/
	array(
	...
	array(
		"id" => $shortname."_sidebar_homepage_ena",
		"name" => "Homepage Siebar Enable",
		"type" => "checkbox",
		"std" => "yes"
	),
	array(
