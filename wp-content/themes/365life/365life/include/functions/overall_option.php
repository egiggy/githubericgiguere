...
**/
	...
	array(
		"name" => "Logo and Menu alignment",
		"id" => $shortname."_logo_menu_align",
		"type" => "select",		
		"options" => array("Logo on right","Logo on left")
	),
	array(
		"type" => "close"
	),
	...
	array(
		"name" => "Logo right margin (or left margin)",
	...
	array(
		"name" => "Menu left margin (or right margin)",
...
**/	
	...
	array(
		"name" => "Youtube",
		"id" => $shortname."_social_link_yt_ena",
		"type" => "checkbox",
		"std" => "yes"
	),
	array(
	...
	array(
		"name" => "Your Youtube URL",
		"id" => $shortname."_social_link_yt_url",
		"type" => "text",
	),
	array(
		"type" => "div_tab_close"
...
**/	
	...
	array(
		"name" => "Below Footer Right Area(Enable)",
		"id" => $shortname."_copyright_right_ena",
		"type" => "checkbox",
		"desc" => "If turn to 'off', the anchor button will be shown instead."
	),
	array(
		"type" => "close"
	),
