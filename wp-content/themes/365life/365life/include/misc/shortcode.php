...
function social_facebook($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/fb.png"></a></div>';
}
add_shortcode("social_facebook", "social_facebook");

function social_reddit($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/red.png"></a></div>';
}
add_shortcode("social_reddit", "social_reddit");

function social_stumble($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/stm.png"></a></div>';
}
add_shortcode("social_stumble", "social_stumble");

function social_delicious($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/dl.png"></a></div>';
}
add_shortcode("social_delicious", "social_delicious");

function social_flickr($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/flk.png"></a></div>';
}
add_shortcode("social_flickr", "social_flickr");

function social_google($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/gg.png"></a></div>';
}
add_shortcode("social_google", "social_google");

function social_googlebuzz($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/ggb.png"></a></div>';
}
add_shortcode("social_googlebuzz", "social_googlebuzz");

function social_lastfm($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/lfm.png"></a></div>';
}
add_shortcode("social_lastfm", "social_lastfm");

function social_linkedin($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/li.png"></a></div>';
}
add_shortcode("social_linkedin", "social_linkedin");

function social_myspace($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/ms.png"></a></div>';
}
add_shortcode("social_myspace", "social_myspace");

function social_twitter($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/twt.png"></a></div>';
}
add_shortcode("social_twitter", "social_twitter");

function social_rss($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/rss.png"></a></div>';
}
add_shortcode("social_rss", "social_rss");

function social_yahoo($atts, $content = null) {
   return '<div class="social-link"><a href="'.$content.'" target="_blank"><img src="'.get_template_directory_uri().'/img/social-link/yh.png"></a></div>';
}
