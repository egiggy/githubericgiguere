...
<div class="social-link-header">
	<ul>
		...
		<?php if($sdt_social_link_yt_ena == "yes"):?>
			<li>
				<a href="<?php echo $sdt_social_link_yt_url;?>" target="_blank" title="youtube" class="tipsy-hover"><img src="<?php echo get_template_directory_uri();?>/include/social-link/icon/youtube.png" alt="" /></a>
			</li>
		<?php endif?>
