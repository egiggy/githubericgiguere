...
(function($){
	...
	$.supersized = function( options ) {
		...
		$(window).load(function(){
			...
			//Custom for 365life theme
			element.fadeIn('fast');		
			$('#slider-frame').slideDown({
                    duration: 'slow',
			...
			if (options.slide_title){
				$('#slidetitle').html(options.slides[currentSlide].title);		
			}
			
			if (options.slide_captions){
				$('#slidecaption').html(options.slides[currentSlide].caption);		
			}
			//Pull caption from array
		...
		function nextslide() {
		    ...
		    if (options.slide_title){
		    	(options.slides[currentSlide].title) ? $('#slidetitle').html(options.slides[currentSlide].title) : $('#slidetitle').html('');
		    }
		    
		    if (options.slide_captions){
		    	(options.slides[currentSlide].caption) ? $('#slidecaption').html(options.slides[currentSlide].caption) : $('#slidecaption').html('');
		    }
		...
		function prevslide() {
		    ...
		    if (options.slide_captions){
		    	(options.slides[currentSlide].title) ? $('#slidecaption').html(options.slides[currentSlide].caption) : $('#slidecaption').html('');
		    }
