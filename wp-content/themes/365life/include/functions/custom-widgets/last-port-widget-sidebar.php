					...
					<?php if(have_posts()) : ?>
						<?php while(have_posts()) : the_post();?>				
									...
									<div class="last-port-wrapper-widget <?php if($i%2 == 0) echo " last"; $i++;?>"> 
												...
												?>
												<div class="port-postthumb">
													<a href="<?php the_permalink();?>" title="<?php the_title();?>" class="tipsy-hover" >	
														<?php //Check wheter thumbnail exists ?>
														<?php if($image_id  == null):?>
															<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/img/default.jpg&amp;h=70&amp;w=87&amp;zc=1" alt="<?php the_title(); ?>"  class="thumb hover"/>
														<?php else: ?>
															<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $image_url[0];?>&amp;h=70&amp;w=87&amp;zc=1" alt="<?php the_title(); ?>"  class="thumb hover"/>
														<?php endif ?>
													</a>
												</div>								
