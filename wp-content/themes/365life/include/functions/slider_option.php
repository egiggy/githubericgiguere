...
$slider = array(
	array(
		...
		"icon" => "slider",
		"type" => "tab_list",
		"options" => array(array("Slider Setting","slider_setting"),array("Slider Images","slider_images"),array("Shortcodes Slider Setting","slider_setting_nivo"))
	),
...
**/
	...
	array(
		"name" => "Slider First State",
		"id" => $shortname."_slide_state",
		"type" => "select",	
		"options" => array("Opened","Closed"),		
		"desc" => "You can choose the first state of slider"
	),
	array(
		"type" => "close"
	),
	array(
		"name" => "Auto Played",
		"id" => $shortname."_slide_auto_played",
		"type" => "checkbox"
	),
	array(
		"type" => "close"
	...
	array(
		"name" => "Time Interval",
		"id" => $shortname."_slide_time_interval",
		"type" => "text",
		"std" => "4000",
		"desc" => "Time period between each images when you're using as 'Auto Played'"
	),
	array(
		"type" => "close"
	),
	array(
		"name" => "Show Arrow",
		"id" => $shortname."_slide_show_arrow",
		"type" => "checkbox",
		"std" => "yes"
	),
	array(
