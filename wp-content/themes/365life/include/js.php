...
function sdt_js(){
	...
	if(!is_admin() && $GLOBALS['pagenow'] != 'wp-login.php' && $GLOBALS['pagenow'] != 'wp-admin/index.php'){
		...
		wp_register_script('jquery-easing', get_template_directory_uri(). '/js/jquery.easing.js', false, '1.3', false);
	...
	// cufon selected
			...
			if(cufonUsed("Bebas")){	
			wp_deregister_script('bebas-font');
			wp_register_script('bebas-font', get_template_directory_uri(). '/fonts/cufon/Bebas_400.font.js', false, '1.0', true);	
			wp_enqueue_script('bebas-font');
			}
		...
		wp_register_script('supersized', get_template_directory_uri(). '/js/supersized.3.1.3.js', false, '3.1', true);
