...
?>
			...
			<form id="contact_form_widget" method="post" action="<?php echo get_stylesheet_directory_uri(); ?>/lib/api.lib.php">
				...
				<p>
				    <input id="your_name" name="your_name" type="text" style="width:90%" title="Name*"/>
				</p>
				<p style="margin-top:20px">
				    <input id="email" name="email" type="text" style="width:90%" title="Email*"/>
				</p>
				<p style="margin-top:20px">
				    <textarea id="message" name="message" rows="2" cols="10" style="width:90%;height:60px" title="Message*"></textarea>
				</p>
				<p style="margin-top:20px">
