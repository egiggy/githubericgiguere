		...
		?>
				...
				<div id="nivo_slider" class="nivoSlider">
							...
							<a href="<?php echo $hyperlink_url;?>">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]; ?>&amp;h=340&amp;w=980&amp;zc=1" alt="" <?php if(!empty($caption_style)) { echo 'title="'.$caption_style.'"'; } ?>/>
							</a>
