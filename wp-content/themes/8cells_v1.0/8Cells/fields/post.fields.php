	...
	$postmetas = 
		array (
			...
			'post' => array(
				...
				*/
				array("section" => "Featured image, video", "id" => "post_featured_content", "type" => "select", "title" => "Select which featured content type you want to display in single post page:", 
				"items" => array(
					"Image" => "Image", 
				...
				array("section" => "Featured image, video", "id" => "post_video_id", "title" => "If you select Youtube Video or Vimeo Video. Enter your video ID here:"),
				
				array("section" => "Featured image, video", "id" => "post_gallery_id", "type" => "select", "title" => "If you select Gallery. Select a gallery here:", "items" => $galleries_select),
