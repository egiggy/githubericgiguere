...
?>	
							...
							<div class="sidebar">
								...
								<div class="content">
									...
									?>
										...
										<ul class="portfolio-main filter" style="border-bottom:0"> 
						...
						?>
								<div class="portfolio-content section content clearfix" style="width:700px;margin-top:10px;">
											<?php
												...
												foreach($page_photo_arr as $key => $portfolio_item)
												{
													...
													$last_class = '';
													$line_break = '';
													$current_float = 'float:left;width:232px;height:130px;margin-bottom:39px;';
											...
											?>
															...
															<?php
																...
																default:
															?>
															<div class="portfolio180_shadow">
																<a href="<?php echo $permalink_url; ?>">
																	<span class="overlay_detail width180">
																	<div>
																	...
																	<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]?>&amp;h=<?php echo $pp_portfolio_image_height; ?>&amp;w=195&amp;zc=1" alt="" class=" " width="195" height="<?php echo $pp_portfolio_image_height; ?>"/>
																</a>
															</div>
															...
															?>
															<div class="portfolio180_shadow">
																<a style="display:block" href="<?php echo $image_url[0]; ?>" class="img_frame">
																	<span class="overlay_detail width180">
																	<div>
																		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_zoom.png" alt=""/><br/>
																		<strong><?php echo $portfolio_item->post_title?></strong>
