    ...
    ////// General Settings
	    $options[] = array(	"name" => "General Settings",
			...
			$options[] = array(	"name" => "Syndication / Feed",
				...
				$options[] = array( "name" => "FeedBurner Feed Counter",				
				                    "desc" => "FeedCount is another cool way to promote your feed. It is a dynamic graphic that always displays your feed's current circulation, as calculated by FeedBurner. <em>Paste full HTML from Feedburner</em> <a href='../wp-content/themes/ebusiness/images/FeedBurner_feedcount.png'>See how &rarr;</a>",
    ...
    /// Featured Slider Settings
		...
		$options[] = array(	"name" => "Front Slider Settings",
			...
			$options[] = array(	"name" => "Pick Height for Your Featured Slider",
				...
				$options[] = array(	"desc" => "Enter the height of featured slider displayed on front page. By default it is <code>300</code>.",
			...
			$options[] = array(	"name" => "Pick Featured Image Size for Your Featured Slider",
				...
				$options[] = array(	"name" => "Height",
				                    "desc" => "Enter the height of featured image displayed in slider custom field. By default height is <code>250</code>.",
