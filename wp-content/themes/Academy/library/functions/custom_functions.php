...
$bizz_metaboxes = array(
		...
		"url" => array (
			"name"		=> "url",
			"default" 	=> "",
			"label" 	=> "Custom Image Destination",
			"type" 		=> "text",
...
function bizzthemes_meta_box() {
	if ( function_exists('add_meta_box') ) {
		add_meta_box('bizzthemes-settings',$GLOBALS['themename'].' Featured Image Settings','bizzthemes_meta_box_content','post','normal','high');
		add_meta_box('bizzthemes-settings',$GLOBALS['themename'].' Featured Image Settings','bizzthemes_meta_box_content','page','normal','high');
	}
}
